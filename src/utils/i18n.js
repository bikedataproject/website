  ...
  resources: {
    en: {
      translations: {
        ...
        Who_can_contribute_contentTwo: 'The non-private aggregated cycling data will be opened up to the public as open data. The open data provided by the Bike Data Project platform is published under Open Data Commons Public Domain Dedication and License (PDDL) v1.0, which imposes no restrictions on your use of the open data and means that it can be freely used by different stakeholders and for different purposes.',
